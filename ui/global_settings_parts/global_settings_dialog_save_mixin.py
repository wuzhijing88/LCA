    ...
    def get_settings(self) -> dict:
        ...
        settings = {
            ...
            'foreground_mouse_driver_backend': require_foreground_backend(
                self.foreground_driver_combo.currentData() if hasattr(self, 'foreground_driver_combo') else self.current_config.get('foreground_mouse_driver_backend', 'interception')
            ),
            'foreground_keyboard_driver_backend': require_foreground_backend(
                self.foreground_keyboard_driver_combo.currentData() if hasattr(self, 'foreground_keyboard_driver_combo') else self.current_config.get('foreground_keyboard_driver_backend', 'interception')
            ),
