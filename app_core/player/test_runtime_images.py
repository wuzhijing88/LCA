...
def test_prepare_player_search_paths_materializes_sounds_without_disk_assets(tmp_path):
    ...
    package = PlayerPackage(
        ...
        assets_images_dir="",
        assets_sounds_dir="",
        entry_workflow_path="memory://workflows/main.json",
        manifest={},
        ui={},
        workflow_data={},
    )
...
def test_prepare_player_search_paths_materializes_maps_without_disk_assets(tmp_path):
    from app_core.player.loader import prepare_player_search_paths
    from app_core.player.package import PlayerPackage

    put_player_memory_file("assets/maps/ab/map.png", b"png-bytes")
    userdata = tmp_path / "userdata"
    package = PlayerPackage(
        package_dir=str(tmp_path),
        export_root=str(tmp_path),
